#! /bin/csh -f
#SBATCH --job-name nudgeClearsky15day
#SBATCH --qos=regular
...
set sst = 300
set run_name = f5e-4_2km_1000km_homoRad_homoSfc_nudgeClearsky_15day		# label for the run
set exp_home = $cwd:h
...
nstop    = 300000,! (259200  30 days, 86400 = 10 days 432000 = 50 days,1296000=150) dt=10
nprint   = 360,
nstat    = 360,
nstatfrq = 360,
...
srun  -n 512 -c 4 --cpu_bind=cores  ./ADV_MPDATA_SGS_TKE_RAD_CAM_MICRO_SAM1MOM > log.txt
