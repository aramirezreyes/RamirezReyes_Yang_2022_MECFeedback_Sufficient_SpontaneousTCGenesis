#! /bin/csh -f
#SBATCH --job-name f5e_nowatervapordiffusion
#SBATCH --qos=debug
...
set sst = 300
set run_name = f5e-4_2km_1000km_homoRad_homoSfc_nowatervapordiffusion		# label for the run
set exp_home = $cwd:h
...
&SGS_TKE_ARR
dosmagor = .false.,
diffuse_microphysics_prognostics = .false.
/
...
nstop    = 3000,!00 (259200  30 days, 86400 = 10 days 432000 = 50 days,1296000=150) dt=10
nprint   = 360,
nstat    = 360,
nstatfrq = 360,
...
srun  -n 512 -c 4 --cpu_bind=cores  ./ADV_MPDATA_SGS_TKE_ARR_RAD_CAM_MICRO_SAM1MOM > log.txt
